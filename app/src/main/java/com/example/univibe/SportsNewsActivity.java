...
import com.example.univibe.model.News;
        ...
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.nav_home) {
                    ...
                    startActivity(new Intent(SportsNewsActivity.this, UserInfoActivity.class));
                    overridePendingTransition(0, 0);
                } else if (itemId == R.id.nav_dev_info) {
                    startActivity(new Intent(SportsNewsActivity.this, DeveloperInfoActivity.class));
                    overridePendingTransition(0, 0);
                }
    ...
    private void initializeViews() {
        ...
        academicBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SportsNewsActivity.this, AcademicNewsActivity.class);
                startActivity(intent);
            }
        });
        sportsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SportsNewsActivity.this, SportsNewsActivity.class);
                startActivity(intent);
            }
        });
        eventsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SportsNewsActivity.this, EventsNewsActivity.class);
                startActivity(intent);
            }
        });
    }
