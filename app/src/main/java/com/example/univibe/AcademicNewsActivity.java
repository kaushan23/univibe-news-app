        ...
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.nav_home) {
                    startActivity(new Intent(AcademicNewsActivity.this, HomeActivity.class));
...
//        bottomNavigationView.setSelectedItemId(R.id.nav_user);
        ...
        sportsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AcademicNewsActivity.this, SportsNewsActivity.class);
                startActivity(intent);
            }
        });
        eventsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AcademicNewsActivity.this, EventsNewsActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void showNoNewsMessage() {
        ...
        noNewsText.setText(R.string.no_academic_news_available_at_the_moment);
