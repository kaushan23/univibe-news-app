...
public class UserInfoActivity extends BaseActivity {
    ...
    private void showDeleteAccountDialog() {
        ...
        TextInputLayout tilConfirmPassword = dialog.findViewById(R.id.til_confirm_password);
        TextInputEditText etConfirmPassword = dialog.findViewById(R.id.et_confirm_password);
        Button btnConfirmDelete = dialog.findViewById(R.id.btn_confirm_delete);
        Button btnCancelDelete = dialog.findViewById(R.id.btn_cancel_delete);

        btnConfirmDelete.setOnClickListener(v -> {
            String password = etConfirmPassword.getText().toString().trim();

            if (password.isEmpty()) {
                tilConfirmPassword.setError("Password is required to delete account");
                return;
            }

            tilConfirmPassword.setError(null);
            deleteUserAccount(password, dialog);
        });
    ...
    private void deleteUserAccount(String password, Dialog dialog) {
                            ...
                            .addOnSuccessListener(unused -> {
                                user.delete()
                                        ...
                                        .addOnFailureListener(e -> {
                                            ...
                                            Toast.makeText(UserInfoActivity.this, "Failed to delete account from authentication", Toast.LENGTH_SHORT).show();
                                        });
                            })
                            .addOnFailureListener(e -> {
                                Log.e(TAG, "Failed to delete user document from Firestore", e);
                                Toast.makeText(UserInfoActivity.this, "Failed to delete user data", Toast.LENGTH_SHORT).show();
                            });
                })
                .addOnFailureListener(e -> {
